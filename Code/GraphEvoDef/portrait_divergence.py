...
""".format(fn=sys.argv[0])
    ...
    if args.graphml:
        ...
        G = nx.read_edgelist(args.filename1, create_using=create_using(), data=(('weight',float),))
        H = nx.read_edgelist(args.filename2, create_using=create_using(), data=(('weight',float),))
    ...
    # print(nx.info(G))
    # print('num of nodes: {}'.format(nx.number_of_nodes(H)))
    # print
    # print('num of edges: {}'.format(nx.number_of_edges(H)))
    # print
    # print('clustering coef: {}'.format(str(round(nx.average_clustering(H),4))))
    # print
    # print('network portrait divergence: {}'.format(str(round(Djs,4))))
    print(round(Djs,4))
    # try:
    #     print('graph diameter : {}'.format(str(round(nx.diameter(H),4))))
    # except:
    #     print("Unexpected error:", sys.exc_info())
    #     print('graph diameter: {}'.format("NA"))
    # print
    # H1 = H.to_undirected()
    # part = community.best_partition(H1)
    # try:
    #     print('graph modularity: {}'.format(str(community.modularity(H1, part))))
    # except:
    #     print("Unexpected error:", sys.exc_info())
    #     print('graph modularity: {}'.format("NA"))
